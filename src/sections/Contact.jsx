...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "prabhakaranwebdeveloper@gmail.com",
    href: "mailto:prabhakaranwebdeveloper@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 6380414057",
    href: "tel:91 6380414057",
  },
  {
    icon: MapPin,
    label: "Location",
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400 ">
            <div className="glass p-5 sm:p-6 md:p-8 rounded-xl">
